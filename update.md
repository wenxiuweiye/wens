...
Shiki 默认支持的语言列表请参阅 [Shiki Languages](https://shiki.style/languages)。更多 Shiki 使用方式请参阅[代码块文档](/zh/guide/use-mdx/code-blocks.md)。
...
通过 [markdown.shiki](/zh/api/config/config-build.md#markdownshiki) 配置 `langAlias` 和其他 Shiki 选项：
...
- **[Notation 行高亮](/zh/guide/use-mdx/code-blocks.md#notation-行高亮)**：使用 `// [!code highlight]` 注释语法，需配置 `transformerNotationHighlight`
- **[Meta 行高亮](/zh/guide/use-mdx/code-blocks.md#meta-行高亮)**：兼容旧版 `{1,3-4}` 语法，需配置 `transformerCompatibleMetaHighlight`
...
更多迁移细节请参考 [plugin-preview 迁移指南](/zh/plugin/official-plugins/preview.md#从-v1-迁移)。
